...
Use the company's own words. The people at the sites who look after ten phones each are "operators", never anchors. There are no supervisors. New workers go through "onboarding screening". The first day at a site is "launch day". The list that travels with the phones is the "phone list". The phones travel in "the provided bag". Names: Manhal, Youssef Medhat (Director of Quality Control and Central Planning), Ahmed Alaa (Head of Finance).

Who owns what. Adham Bedir (CEO) owns the client, contracts, prices, and the second signature on large payments. Moharam (Director of Operations) owns the field: every site, shift, and daily target, the Portfolio Managers, and tier 2 incidents. Mano (Chief of Staff) owns people, papers and filings, gear and the store, the hubs, and the nightly company report. Ahmed Alaa (Head of Finance) owns all money: payroll, payments, the invoice, and month end. Youssef Medhat owns quality and central planning. Mazen (Head of Deployment) opens every new site. Youssif Siessa (CTO) owns technology and quality. Aly Siessa (CPO) owns hardware.
