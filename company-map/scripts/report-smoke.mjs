...
if (process.env.DR_REPORT_CODE) {
  ...
  if (rep.status === 200) console.log(`report ${day}: ${rep.body.totals.reported} of ${rep.body.expected} sites in, ${rep.body.totals.hours} hours, target ${rep.body.target_day} a day`);
}
