...
- No one named Mustafa or Yahia. The org is exactly this. Adham (CEO), Youssif (CTO), and Aly (CPO) are the founders. Moharam (Director of Operations), Mano (Chief of Staff), and Ahmed Alaa (Head of Finance) report to Adham. Under Moharam: the Planning and Logistics Lead (open seat), Mazen (Head of Deployment), and the Portfolio Managers (Eyad, Ahmed Sabry, Manhal, Hazem, plus open seats). Site leads and operators sit under the Portfolio Managers. Youssef Medhat (Director of Quality Control and Central Planning) reports to Youssif, with the QC reviewers under him. Ali (hardware design, Egypt) reports to Aly. Open seats: China procurement and tech support. Delivery partners sit outside the chart. There is no Head of Activation, no QC Lead, no HR seat, and no business development seat.
- Facts come from `data/`. Do not invent new numbers. The numbers live in data/site.json. Do not duplicate them here.
