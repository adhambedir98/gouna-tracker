...
const app = await mount({
  ...
  title: { en: m.title },
  lede: { en: m.purpose },
  toc: [{ id: 'life', label: L("The phone's life") }, { id: 'kit', label: L('The site kit') }, { id: 'count', label: L('The weekly count') }, { id: 'fleets', label: L('Fleets') }, ...MANUAL_TOC]
});
