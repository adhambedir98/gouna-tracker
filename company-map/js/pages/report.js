...
function done(o) {
  app.content.innerHTML = `<div class="card panel sent" id="sent">
    ...
    ${o.hours == null ? `<p class="callout late">${esc(L('The hours were not counted: no phone was listed. Add the phones and their minutes, then send this again.'))}</p>` : ''}
...
try {
  ...
  opts = { sites: o.sites || [], people: o.people || [], deadline: o.deadline || '18:00', phones: o.phones || {}, phones_max: Number(o.phones_max) || 270, me: o.me || { signed_in: false } };
  render();
