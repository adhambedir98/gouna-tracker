...
app.content.innerHTML = `
  ...
  <div class="cards two">
    ${card('dashboard', T('Dashboard', 'لوحة المتابعة'), T('The day in one page: every phone on a map of Egypt at its site, every business with its hours, and the month against the target.', 'اليوم في صفحة واحدة: كل هاتف على خريطة مصر في موقعه، وكل عمل بساعاته، والشهر مقابل الهدف.'))}
  ...
  <section>
  <h2>${T('Paper copies', 'النسخ الورقية')}</h2>
  <p class="intro">${T('Print these, or fill them in on a phone.', 'اطبع هذه، أو املأها على الهاتف.')}</p>
