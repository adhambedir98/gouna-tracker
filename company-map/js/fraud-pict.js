...
export function fraudPict(kind, L) {
  ...
  switch (kind) {
    case 'idle': s += cone(46, 13, 0, 58) + person(34, 22, { arms: 'still' }) + rect(59, 3, 68, 22, 'bx', 'stroke-dasharray="3 3"') + text(93, 18, L('same frame'), { cls: 'tx tx-s tx-m', anchor: 'middle' }); break;
